...
```shell
CUSTOM_TEMPLATES_DIRECTORY="/var/lib/xpert/templates/"
```
...
```shell
mkdir /var/lib/xpert/templates/sing-box
```
...
```
Now, restart your Xpert and enjoy.

If you have already changed your env variables, and you want to just update the template files, there is no need to restart Xpert.
